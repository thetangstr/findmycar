"""
Wrapper for AutoTrader client to standardize interface
"""
from autotrader_client import AutotraderClient
from typing import Dict, Optional

class AutoTraderWrapper:
    def __init__(self):
        self.client = AutotraderClient()
    ...
    def search_vehicles(self, query: str = "", make: Optional[str] = None,
        ...
        try:
            ...
            return {
                'vehicles': vehicles,
                'total': len(vehicles),  # AutoTrader doesn't provide total
                'page': page,
                'per_page': per_page,
                'source': 'autotrader'
            }
